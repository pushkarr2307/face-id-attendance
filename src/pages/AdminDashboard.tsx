...
import {
  getStudents, saveStudents, getAttendance, isAdminLoggedIn,
  loginAdmin, logoutAdmin, Student, AttendanceRecord
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              ...
              { label: "Avg Rate", value: students.length ? `${Math.round((attendance.length / Math.max(students.length, 1)) * 10)}%` : "0%", color: "text-primary" },
            ].map((s) => (
              <div key={s.label} className="bg-gradient-card rounded-xl border border-border p-4">
